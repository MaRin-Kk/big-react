...
export const beginWork = (wip: FiberNode, renderLanes: Lane) => {
  // 比较子fiberNode
  switch (wip.tag) {
    case HostRoot:
    ...
    case FuntionComponent:
      return updateFuntionComponent(wip, renderLanes)
    case Fragment:
...
function updateFuntionComponent(wip: FiberNode, renderLanes: Lane) {
...
function updateHostRoot(wip: FiberNode, renderLanes: Lane) {
